...
void adc_iomuxc(ADCCH_enum ch) {
  ...
  case ADC1_CH0_B27:
  case ADC2_CH0_B27:
    iomuxc_pinconf(B27, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH1_B12:
    iomuxc_pinconf(B12, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH2_B13:
    iomuxc_pinconf(B13, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH3_B14:
    iomuxc_pinconf(B14, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH4_B15:
    iomuxc_pinconf(B15, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH5_B16:
  case ADC2_CH5_B16:
    iomuxc_pinconf(B16, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH6_B17:
  case ADC2_CH6_B17:
    iomuxc_pinconf(B17, ALT5, ADC_PIN_CONF);
    break;

  case ADC2_CH7_B18:
  case ADC1_CH7_B18:
    iomuxc_pinconf(B18, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH8_B19:
  case ADC2_CH8_B19:
    iomuxc_pinconf(B19, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH9_B20:
  case ADC2_CH9_B20:
    iomuxc_pinconf(B20, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH10_B21:
  case ADC2_CH10_B21:
    iomuxc_pinconf(B21, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH11_B22:
  case ADC2_CH11_B22:
    iomuxc_pinconf(B22, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH12_B23:
  case ADC2_CH12_B23:
    iomuxc_pinconf(B23, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH13_B24:
  case ADC2_CH13_B24:
    iomuxc_pinconf(B24, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH14_B25:
  case ADC2_CH14_B25:
    iomuxc_pinconf(B25, ALT5, ADC_PIN_CONF);
    break;

  case ADC1_CH15_B26:
  case ADC2_CH15_B26:
    iomuxc_pinconf(B26, ALT5, ADC_PIN_CONF);
    break;

  case ADC2_CH1_B28:
    iomuxc_pinconf(B28, ALT5, ADC_PIN_CONF);
    break;

  case ADC2_CH2_B29:
    iomuxc_pinconf(B29, ALT5, ADC_PIN_CONF);
    break;

  case ADC2_CH3_B30:
    iomuxc_pinconf(B30, ALT5, ADC_PIN_CONF);
    break;

  case ADC2_CH4_B31:
    iomuxc_pinconf(B31, ALT5, ADC_PIN_CONF);
    break;
...
//  @param      ch              选择ADC通道
//  @param      resolution
//  选择选择通道分辨率(如果同一个模块初始化时设置了不同的分辨率
//  则最后一个初始化的分辨率生效)
//  @return     void
...
//  @param      count           均值滤波次数
//  @return     void
//  Sample usage:               adc_convert(ADC_1,ADC1_CH0_B27,5);//采集5次
//  然后返回平均值
//-------------------------------------------------------------------------------------------------------------------
