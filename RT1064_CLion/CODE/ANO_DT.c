...
/*!
  ...
  * @date     2019/5/28 星期二
  */
void ANO_DT_Send_Data(UARTN_enum USARTN, unsigned char *dataToSend, unsigned short length) {
...
/*!
  ...
  * @date     2019/5/28 星期二
  */
void ANO_DT_send_int16(UARTN_enum USARTN, short data1, short data2, short data3, short data4, short data5, short data6, short data7, short data8) {
    ...
    ANO_DT_Send_Data(USARTN, data_to_send, _cnt);
}
