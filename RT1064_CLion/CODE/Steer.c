...
*/
    ...
    if(Steer_PID->CurrentValue > 0.0)   //往右转
    {
        if(Steer_PID->CurrentValue <= 2.5)
        {
            Steer_PID->KP = 5.56f + (float)Angle * 0.80f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=1.10f + (float)Angle * 0.16f;

        }
        else if(Steer_PID->CurrentValue > 2.5 && Steer_PID->CurrentValue <= 5.5)
        {
            Steer_PID->KP = 7.56f + (float)(Angle-2.5) * 0.60f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=1.50f + (float)(Angle-2.5) * 0.17f;
        }
        else if(Steer_PID->CurrentValue > 5.5 && Steer_PID->CurrentValue <= 8.0)
        {
            Steer_PID->KP = 9.35f + (float)(Angle-5.5) * 0.80f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=2.00f + (float)(Angle-5.5) * 0.20f;

        }
        else if(Steer_PID->CurrentValue > 8.0 && Steer_PID->CurrentValue <= 10.5)
        {
            Steer_PID->KP = 11.35f + (float)(Angle-8.0) * 0.86f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=2.50f + (float)(Angle-8.0) * 0.40f;
        }
        else
        {
            Steer_PID->KP = 13.5f;
    ...
    else                               //往左转
    {
        if(Steer_PID->CurrentValue > -2.5)
        {
            Steer_PID->KP = 5.83f + (float)Angle * 0.80f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=1.10f + (float)Angle * 0.16f;
        }
        ...
        {
            Steer_PID->KP = 7.83f + (float)(Angle-2.5) * 0.48f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=1.50f + (float)(Angle-2.5) * 0.17f;
        }
        else if(Steer_PID->CurrentValue < -5.5 && Steer_PID->CurrentValue > -8.5)
        {
            Steer_PID->KP = 9.26f + (float)(Angle-5.5) * 0.67f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=2.00f + (float)(Angle-5.5) * 0.17f;
        }
        else if(Steer_PID->CurrentValue < -8.5 && Steer_PID->CurrentValue > -10.5)
        {
            Steer_PID->KP = 11.26f + (float)(Angle-8.5) * 1.12f;
            Steer_PID->KI = 0.1f;
            Steer_PID->KD = 1.32f;
            Rate=2.50f + (float)(Angle-8.5) * 0.50f;
        }
        else
        {
            Steer_PID->KP = 13.5f;
