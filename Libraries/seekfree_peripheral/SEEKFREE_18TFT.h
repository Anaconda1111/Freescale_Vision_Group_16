...
#define TFT_SCL     SPI4_SCK_C23   //定义SPI_SCK引脚
#define TFT_SDA     SPI4_MOSI_C2   //定义SPI_MOSI引脚
#define TFT_SDA_IN  SPI4_MISO_C21   //定义SPI_MISO引脚  IPS没有MISO引脚，但是这里任然需要定义，在spi的初始化时需要使用
#define TFT_CS      SPI4_CS3_C27    //定义SPI_CS引脚
                    
#define BL_PIN		C24	            //液晶背光引脚定义  
#define REST_PIN	C25              //液晶复位引脚定义 由于实际通讯未使用D15因此 这里复用为GPIO
#define DC_PIN		C26	            //液晶命令位引脚定义
